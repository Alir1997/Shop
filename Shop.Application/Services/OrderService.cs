...
namespace Shop.Application.Services
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<FinalyOrderResult> FinalyOrder(FinalyOrderViewModel finallyOrder, long userId)
        {
            if (userId != finallyOrder.UserId)
            {
                return FinalyOrderResult.HasNotUser;
            }
        ...
        public async Task ChangeIsFinalyToOrder(long orderId)
        {
            var order = await _orderRepository.GetOrderById(orderId);
