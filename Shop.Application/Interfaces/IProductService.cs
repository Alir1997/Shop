...
namespace Shop.Application.Interfaces
{
    public interface IProductService
    {
        ...
        Task<CreateProductResult> CreateProduct(CreateProductViewModel createProduct,IFormFile imageProcudt);
        Task<List<ProductCategory>> GetAllProductCategories();
        Task<EditProductViewModel> GetEditProduct(long productId);
        Task<EditProductResult> EditProduct(EditProductViewModel editProductView);
