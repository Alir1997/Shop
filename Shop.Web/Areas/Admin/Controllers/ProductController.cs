...
namespace Shop.Web.Areas.Admin.Controllers
{
    public class ProductController : AdminBaseController
    {
        ...
        #endregion
        #region list product gaalleries
        ...
        public async Task<IActionResult> CreateProductFeatuers(CreateProductFeatuersViewModel featuersViewModel)
        {
            if (ModelState.IsValid)
            {
                var result = await _productService.CreateProductFeatuers(featuersViewModel);
                switch (result)
                {
        ...
        #region delete product Featuers
        public async Task<IActionResult> DeleteFeatuers(long FeatuerId)
        {
            await _productService.DeleteFeatures(FeatuerId);
            return RedirectToAction("FilterProducts");
        }
        #endregion
        #endregion
